...
public:
	...
	void SetSubjob(UINT Index, bool Value)
	{
		if(Index < 4)
		{
...
public:
	...
	/* 01D0 */ int nPkPardon;
	/* 01D4 */ int nKarma;
	/* 01D8 */ USHORT _unkn1d8;
	/* 01DA */ SHORT nUsedSulffrage;
	/* 01DC */ int nEvalScore;
	...
	/* 04C8 */ double MaxMP;
	/* 04D0 */ double MaxCP; 
	/* 04D8 */ double _unkn4D8;
	/* 04E0 */ double _unkn4e0;
	/* 04E8 */ double _unkn4E8;// forgspeed ?
	/* 04F0 */ double hpRegen;
	/* 04F8 */ double mpRegen;
	/* 0500 */ double cpRegen;
	/* 0508 */ double _f508;
	...
	/* 0548 */ double accakSpeedBonus1_8;
	/* 0550 */ int _n550;
	/* 0554 */ int _n554;
	/* 0558 */ int _n558;
	/* 055C */ int _n55C;
	...
	/* 05C0 */ double fMAtk;
	/* 05C8 */ double fMDef;
	/* 05D0 */ double attackSpeed;
	/* 05D8 */ double criticalRate;	//final critical rate
	/* 05E0 */ double fBaseAtkSpeed;
	/* 05E8 */ double fBaseCastSpeed; //AtkSpeed
	/* 05F0 */ double castingSpeed;
	/* 05F8 */ int _n5F8;
	/* 05FC */ int _n5FC;
	/* 0600 */ int _n600;
	/* 0604 */ int _n604;
	...
	/* 0768 */ UINT nSummonSpawnTick;
	/* 076C */ UINT nSummonExpireTime;	//in miliseconds 1200000 by default
	/* 0770 */ int _n0770;
	/* 0774 */ int _n0774;
	...
	/* 07D4 */ int _n07D4;
	/* 07D8 */ CreatureSharedData *pMasterSD;
	/* 07E0 */ int nAction;
	/* 07E4 */ int _n07E4;
	/* 07E8 */ int _n07E8;
	/* 07EC */ int _n07EC;
