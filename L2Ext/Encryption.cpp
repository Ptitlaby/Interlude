...
void CPacketEncryption::Init()
{
	...
	for(int n=0;n<80;n++)
	{
		...
		g_StaticKey[n][0] = (BYTE) 0x94;
		g_StaticKey[n][1] = (BYTE) 0x35;
		g_StaticKey[n][2] = (BYTE) 0x00;
		g_StaticKey[n][3] = (BYTE) 0x00;
		g_StaticKey[n][4] = (BYTE) 0xa1;
		g_StaticKey[n][5] = (BYTE) 0x6c;
		g_StaticKey[n][6] = (BYTE) 0x54;
		g_StaticKey[n][7] = (BYTE) 0x87;
	}
}
